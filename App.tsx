...
const Landing: React.FC<{ 
  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen bg-mint-base dark:bg-slate-950 overflow-x-hidden relative no-scrollbar scroll-smooth">
      ...
      {/* Landing Header */}
      <header className="flex items-center justify-between px-4 sm:px-12 py-6 sticky top-0 bg-mint-base/90 dark:bg-slate-950/90 backdrop-blur-md z-[60] relative">
      ...
      {/* Trending Recipes */}
      <section className="px-4 sm:px-12 py-32 bg-slate-50/10 dark:bg-slate-900/10 backdrop-blur-md relative z-10">
              ...
              <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-8 max-w-[1084px] mx-auto w-full">
                ...
                <div className="flex flex-wrap gap-4 no-print">
                  <button 
                    ...
                    className="flex-1 sm:flex-none px-8 py-4 bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-200 border border-slate-200 dark:border-700 rounded-[1.5rem] font-black text-sm flex items-center justify-center gap-3 hover:bg-slate-50 transition-all active:scale-95"
                  >
